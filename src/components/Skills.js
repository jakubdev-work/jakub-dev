      ...
      <div className="devman_tm_skills">
        <div className="container">
          <div className="devman_tm_main_title" data-text-align="center">
            ...
            <p>
              My skills blend creativity, technical expertise, and
              problem-solving to deliver innovative and effective solutions.
            </p>
          </div>
          <div className="skills_wrapper">
            <div className="left">
              <div className="dodo_progress">
                ...
                >
                  <span>
                    <span className="label">React & Next, Express.js</span>
                ...
                >
                  <span>
                    <span className="label">Django & Flask</span>
